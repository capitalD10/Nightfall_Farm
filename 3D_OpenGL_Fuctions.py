...
def draw_hud():
    ...
    glBegin(GL_QUADS)
    glVertex3f(5, 755, 0); glVertex3f(220, 755, 0); glVertex3f(220, 785, 0); glVertex3f(5, 785, 0)
    glEnd()
    glColor3f(0.3, 0.3, 0.3)
    glBegin(GL_QUADS)
    glVertex3f(10, 760, 0); glVertex3f(210, 760, 0); glVertex3f(210, 778, 0); glVertex3f(10, 778, 0)
    glEnd()
    hp_ratio = max(0, player_health) / 100.0
    glColor3f(0.9, 0.1, 0.1)
    glBegin(GL_QUADS)
    glVertex3f(10, 760, 0); glVertex3f(10 + 200 * hp_ratio, 760, 0)
    glVertex3f(10 + 200 * hp_ratio, 778, 0); glVertex3f(10, 778, 0)
    glEnd()
    # Time bg
    glColor3f(0.1, 0.1, 0.15)
    glBegin(GL_QUADS)
    glVertex3f(WINDOW_W // 2 - 110, 755, 0); glVertex3f(WINDOW_W // 2 + 110, 755, 0)
    glVertex3f(WINDOW_W // 2 + 110, 785, 0); glVertex3f(WINDOW_W // 2 - 110, 785, 0)
    glEnd()
    # Stats bg
    glColor3f(0.1, 0.1, 0.15)
    glBegin(GL_QUADS)
    glVertex3f(WINDOW_W - 195, 710, 0); glVertex3f(WINDOW_W - 5, 710, 0)
    glVertex3f(WINDOW_W - 5, 785, 0); glVertex3f(WINDOW_W - 195, 785, 0)
    glEnd()
    # Bottom bar bg
    glColor3f(0.1, 0.1, 0.15)
    glBegin(GL_QUADS)
    glVertex3f(0, 0, 0); glVertex3f(WINDOW_W, 0, 0); glVertex3f(WINDOW_W, 30, 0); glVertex3f(0, 30, 0)
    glEnd()
    glPopMatrix()
    glMatrixMode(GL_PROJECTION)
    glPopMatrix()
    ...
    glColor3f(0.8, 0.8, 0.8)
    draw_text(40, 10, "E:Interact  F:Fish  T:Trade  C:Craft  Q:Auto  LMB:Fire  V:Camera  ESC:Menu", GLUT_BITMAP_HELVETICA_18)
    # Low HP warning
...
def draw_inventory_ui():
    ...
    draw_text(430, 660, "INVENTORY", GLUT_BITMAP_HELVETICA_18)
    items = []
    ...
    glColor3f(0.6, 0.6, 0.6)
    draw_text(250, 130, "UP/DOWN: Select  ENTER: Eat Food  ESC: Close", GLUT_BITMAP_HELVETICA_18)
    glEnable(GL_DEPTH_TEST)
...
def draw_death_screen():
    ...
    glMatrixMode(GL_MODELVIEW)
    glColor3f(1.0, 0.2, 0.2)
    draw_text(380, 500, "YOU DIED", GLUT_BITMAP_HELVETICA_18)
    glColor3f(1.0, 1.0, 1.0)
...
def draw_menu():
    ...
    # Title
    glColor3f(1.0, 0.85, 0.2)
    draw_text(380, 610, "NIGHTFALL FARM", GLUT_BITMAP_HELVETICA_18)
    # Menu 
